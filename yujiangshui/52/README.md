...
### 基础思想：《离散数学及其应用》（Discrete Mathematics and Its Applications）

离散数学相关，数学归纳、递归、分治算法、排列组合、树和遍历、图等都有深入介绍。

### 概率：《概率统计》（Probability and Statistics）

概率论常用知识点，包括随机变量及其分布、条件概率、期望值、也被撕、马尔可夫链等。

### 线性代数：《线性代数及其应用》（Linear Algebra and Its Applications）

线性方程、向量空间、特征向量、奇异值分解等。
...
- Coursera 上有离散数学的课，推荐
- 概率统计中文书：浙江大学出版的《概率论与数理统计》第 4 版、同济大学出版的《概率论与数理统计》
- 《具体数学》
...
微积分通常只会用到少数非常专的算法之中，对于日常的编程用的很少。不过微积分的思想还有有用的，便于你理解离散值和连续值的变化，对于一些机器学习算法，需要使用这两者之间的转换来变换特征值。
